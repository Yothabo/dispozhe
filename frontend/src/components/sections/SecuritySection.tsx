      ...
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-xl text-grey-light max-w-3xl mx-auto leading-relaxed font-light">
            The system is designed to prevent data retention and unauthorized access.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
          <div className="glass rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 w-full">
            <div className="flex items-center gap-4 mb-6 sm:mb-8">
              <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white">What the system does not do</h3>
            </div>
          ...
          <div className="glass rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 w-full">
            <div className="flex items-center gap-4 mb-6 sm:mb-8">
              <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white">What the system provides</h3>
            </div>
            <ul className="space-y-3 sm:space-y-4 lg:space-y-5">
              <li className="flex items-center gap-3 sm:gap-4 text-sm sm:text-base lg:text-lg text-grey">
