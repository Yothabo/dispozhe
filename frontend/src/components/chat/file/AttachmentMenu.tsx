...
const AttachmentMenu: React.FC<AttachmentMenuProps> = ({
  ...
  return (
    <>
      ...
      {/* Menu - non-interactive container */}
      <div
        className={`fixed inset-0 z-50 flex items-end justify-center pb-20 pointer-events-none`}
      >
        <div
          className="glass rounded-2xl p-6 w-full max-w-md border border-white/10 shadow-2xl transition-all duration-300 ease-out pointer-events-auto"
          style={{
