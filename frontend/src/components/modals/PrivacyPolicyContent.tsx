  ...
  return (
    <div className="text-grey space-y-6">
      <p className="text-sm leading-relaxed">
        Chatlly is designed with a fundamental principle: we do not collect, store, or have access to your conversations. This policy outlines our data practices.
      </p>
      <div className="space-y-4">
        <h4 className="text-white font-semibold">1. Data Collection</h4>
        <p className="text-sm leading-relaxed">
          Chatlly does not collect personally identifiable information. Session identifiers are randomly generated and stored temporarily in memory for the duration of the active session.
        </p>
      </div>
      <div className="space-y-4">
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm leading-relaxed">
          Chatlly does not share data with third parties. As no personal information or message content is collected, there is no data to share.
        </p>
      </div>
      <div className="space-y-4">
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm leading-relaxed">
          Updates to this privacy policy will be reflected on this page. Continued use of Chatlly constitutes acceptance of the current policy.
        </p>
      </div>
