  ...
  return (
    <div className="text-grey space-y-6">
      <p className="text-sm leading-relaxed">
        Driflly enables private communication through a five-step process designed to leave no persistent record.
      </p>
      <div className="space-y-4">
        <h4 className="text-white font-semibold">1. Session creation</h4>
        <p className="text-sm leading-relaxed">
          A user initiates a chat with a default 5-minute duration. An encryption key is generated locally on the user&apos;s device. The key is never transmitted to servers.
        </p>
      </div>
      <div className="space-y-4">
      ...
      <div className="space-y-4">
        <h4 className="text-white font-semibold">4. Flexible duration</h4>
        <p className="text-sm leading-relaxed">
          The 5-minute timer can be extended by either participant during the conversation. The timer is always visible and updates in real-time.
        </p>
      </div>
      <div className="space-y-4">
        <h4 className="text-white font-semibold">5. Session termination</h4>
        <p className="text-sm leading-relaxed">
