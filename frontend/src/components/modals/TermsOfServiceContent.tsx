  ...
  return (
    <div className="text-grey space-y-6">
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm leading-relaxed">
          While the service is designed for reliability, uninterrupted access is not guaranteed. The service may be temporarily unavailable due to maintenance or technical issues.
        </p>
      </div>
      <div className="space-y-4">
